...
<script type="text/javascript"> 
    ...
    LoginRadius_SocialLogin.util.ready(function () {  
        $ui = LoginRadius_SocialLogin.lr_login_settings;$ui.interfacesize = "small";$ui.apikey = "<?php echo $lr_settings['apikey'] ?>";
        $ui.callback="<?php echo $loc; ?>";
...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
   ...
   <?php endif; ?>
    ...
    if (!$dob_exists) {
       $query = "ALTER TABLE #__LoginRadius_users ADD dob varchar(255) NULL";
       $db->setQuery( $query );
       $db->query();
    }
    if (!$gender_exists) {
       $query = "ALTER TABLE #__LoginRadius_users ADD gender boolean NULL";
       $db->setQuery( $query );
       $db->query();
    }
  endif;?>
