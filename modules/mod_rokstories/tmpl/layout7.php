<?php
/**
 * @version   $Id: layout7.php 6796 2013-01-27 19:56:01Z btowles $
...
<div id="rokstories-<?php echo $module->id; ?>" class="rokstories-<?php echo $layout; ?><?php echo $content_right; ?> rt-gallery-container"  <?php echo $style; ?>>
	...
	<?php if ($count > 0): ?>
		<div class="rt-gallery-controls-container">
			<div class="rt-gallery-controls">
				<div class="rt-gallery-controls2">
					<div class="rt-gallery-controls3">
						<?php if ($show_titles): ?>
							<div class="rt-gallery-title">
								...
								foreach ($list as $item) {
									...
									if ($link_titles) echo "<a href='" . $item->link . "'" . $cls . "><span>" . $item->title . "</span></a>"; else echo "<span" . $cls . ">" . $item->title . "</span>";
									$count++;
								}
								?>
							</div>
