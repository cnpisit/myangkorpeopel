<?php
/**
 * @version   $Id: ajax.php 6796 2013-01-27 19:56:01Z btowles $
...
$install_sql = dirname(__FILE__) . '/' . "../install.rokstories.sql";
...
// Check for existance
if (JFactory::getApplication()->input->getBool("duplicate") != 'true') {
