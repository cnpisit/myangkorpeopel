<?php
/**
 * @version   $Id: layout3.php 6796 2013-01-27 19:56:01Z btowles $
...
if ($height != 0 && $height != '0') $style = 'style="height: ' . $height . 'px;"'; else $style = "";
$image_pad = '';
$content_pad = '';
	...
	<div class="feature-block">
			...
			<div class="desc-container">
				<?php if ($contentOptions): ?>
					<div class="feature-block-top">
						<div class="feature-block-top2"></div>
						<div class="feature-block-top3"></div>
					</div>
				<?php endif; ?>
							...
							<?php if ($params->get("show_article_link", 1) == 1): ?>
								<?php if ($params->get('legacy_readmore', 1) == 1): ?>
									...
									<div class="readon-wrap1">
										...
										<a href="<?php echo $item->link; ?>" class="readon-main"><span class="readon1-m"><span class="readon1-r"><?php echo JText::_('ROKSTORIES_READMORE'); ?></span></span></a>
									</div>
									<div class="clr"></div>
								<?php endif; ?>
				...
				<?php if ($contentOptions): ?>
					<div class="feature-block-bottom">
						<div class="feature-block-bottom2"></div>
						<div class="feature-block-bottom3"></div>
					</div>
				<?php endif; ?>
			</div>
		</div>
		<div class="feature-circles">
			<?php $i = 0; foreach ($list as $item): ?>
				<?php
				if ($i == $params->get('startElement', 0)) $class = ' active'; else $class = '';
				?>
