<?php
/**
* @version   $Id: modules.php 5014 2012-11-01 20:14:12Z josh $
...
global $Itemid;
	...
	<div class="rt-block <?php global $gantry; if (preg_match("/box[0-3]{1,}/i", $params->get('submenu-module_sfx'))){echo 'rt-dark-block';} else {echo 'rt-'.$gantry->get("blocks-default-overlay").'-block ';} if ($params->get('submenu-module_sfx')!='') : ?><?php echo $params->get('submenu-module_sfx'); ?><?php endif; ?>">
...
{
 	if (!empty ($module->content)) : ?>
           <div class="rt-block <?php global $gantry; if (preg_match("/box[0-3]{1,}/i", $params->get('moduleclass_sfx'))){echo 'rt-dark-block';} else {echo 'rt-'.$gantry->get("blocks-default-overlay").'-block';} if ($params->get('moduleclass_sfx')!='') : ?> <?php echo $params->get('moduleclass_sfx'); ?><?php endif; ?>">
           	<div class="module-surround">
