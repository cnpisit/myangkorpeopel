<?php
/**
 * @version   $Id: index.php 4218 2012-10-09 08:11:52Z josh $
	...
	<div class="sprocket-mosaic-header">
		...
		<div class="sprocket-mosaic-filter">
			<ul>
				...
				<li class="<?php echo $key;?><?php echo $key == 'all' ? ' active' : '';?>" data-mosaic-filterby="<?php echo $key; ?>"><span><?php echo $filter; ?></span></li>
				<?php endforeach; ?>
			</ul>
		</div>
		<?php endif; ?>
		...
		<div class="sprocket-mosaic-order">
			<ul>
				...
				<li<?php echo !$i && $order != 'random' ? ' class="active"' : ''; ?> data-mosaic-orderby="<?php echo $order; ?>"><span><?php rc_e('ROKSPROCKET_MOSAIC_ORDERING_' . strtoupper($order)); ?></span></li>
				<?php endforeach; ?>
			</ul>
		</div>
		<?php endif; ?>
